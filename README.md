...
An [environment file](environment.yml) is included within the repository. This can be run through the command line or through Anaconda Navigator.
...
### Creating a short walking route between London Marylebone and London Paddington train stations (Figure 11)
...
### Creating a cycling route between London Marylebone and City of London (Figure 12)
...
### Using postcodes to map a cycling route between two London museums (Figure 13)
...
### Using the tool to navigate between tourist landmarks (Figure 14)
...
### Using the tool for a very long distance route from Uxbridge to Woolwich (Figure 15)
...
### Demonstrating the progress bar with a short route
